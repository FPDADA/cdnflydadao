...
download "https://cloudflare.rpdl.8mi.work/https://github.com/FPDADA/cdnflydadao/tree/main/agent/$tar_gz_name" "https://cloudflare.rpdl.8mi.work/https://github.com/FPDADA/cdnflydadao/tree/main/agent/$tar_gz_name" "$tar_gz_name" --no-check-certificate
