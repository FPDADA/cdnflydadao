...
download "https://cloudflare.rpdl.8mi.work/https://github.com/FPDADA/cdnflydadao/tree/raw/agent/$tar_gz_name" "https://cloudflare.rpdl.8mi.work/https://github.com/FPDADA/cdnflydadao/tree/raw/agent/$tar_gz_name" "$tar_gz_name"
